...
const Post = ({
  ...
  return (
    <Container>
      <Header>
        <Touchable
          onPress={() => navigate("UserDetail", { userName: user.userName })}
        >
          <Image
      ...
      <InfoContaier>
        <IconsContainer>
          ...
          <Touchable
            onPress={() => navigate("CommentDetail", { comments: comments })}
          >
            <IconContainer>
        ...
        <LikeContainer>
          <Touchable>
            <Bold>
              {likeCount === 0 ? "좋아요 0개" : `좋아요 ${likeCount}개`}
            </Bold>
          </Touchable>
          <Caption>
        ...
        <CommentAll>
          <Touchable
            onPress={() =>
              navigate("CommentDetail", { comments: comments, id: id })
            }
          >
